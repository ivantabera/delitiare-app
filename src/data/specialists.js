export const specialists = [
  ...
  },
  {
    ...
    name: "Priscila",
    role: "Especialista Delitiāre",
    image: "/assets/specialists/Priscila/Fotoprincipal.jpeg", // Nota: Corregí .jpg a .jpeg según tu patrón
    ...
    bioTitle: "Acerca de Priscila",
    bioParagraphs: [
      "Priscila vibra con una fuerza que envuelve y conquista.",
      "Su energía alegre y magnética se transmite desde que la ves hasta el momento en que su toque te conduce a la relajación total.",
      "Ella juega con ritmos e intensidades, creando sesiones vivas y sensorialmente intrigantes.",
      "Con Pris no solo recibes un masaje: descubres tu cuerpo a través de una experiencia distinta y cautivadora."
    ]
  },
  {
    id: "vivian",
    name: "Vivián",
    role: "Especialista Delitiāre",
    image: "/assets/specialists/Vivian/Fotoprincipal.jpeg",
    description: "Atención personalizada con presencia impecable y un toque etéreo. Vivian integra técnicas de relajación profunda con una sutileza sensorial.",
    metaDescription: "Agenda una sesión con Vivián. Experiencia premium para hombres en CDMX.",
    gallery: [
      "/assets/specialists/Vivian/01-vivian.jpeg",
      "/assets/specialists/Vivian/02-vivian.jpeg",
      "/assets/specialists/Vivian/03-vivian.jpeg",
      "/assets/specialists/Vivian/04-vivian.jpeg"
    ],
    bioTitle: "Acerca de Vivián",
    bioParagraphs: [
      "Vivian es una invitación al nirvana.",
      "Su energía dulce, fresca y ligera crea un espacio donde el tiempo parece detenerse.",
  ...
  },
  {
    ...
    name: "Tess",
    role: "Especialista Delitiāre",
    image: "/assets/specialists/Tess/Fotoprincipal.jpeg",
    description: "Atención personalizada con presencia envolvente y manos intuitivas. Tess combina técnicas de relajación profunda con un toque cálido y emocional.",
    metaDescription: "Agenda una sesión con Tess. Experiencia premium para hombres en CDMX.",
    gallery: [
      "/assets/specialists/Tess/01-tess.jpeg",
      "/assets/specialists/Tess/02-tess.jpeg",
      "/assets/specialists/Tess/03-tess.jpeg",
      "/assets/specialists/Tess/04-tess.jpeg"
    ],
    bioTitle: "Acerca de Tess",
    bioParagraphs: [
      "Tess es misterio amable y luz inesperada.",
      "A simple vista es dulce y encantadora, pero quienes se permiten entrar a su energía descubren algo más íntimo: una presencia que acaricia con profundidad emocional.",
